...
def patch(path: Path, beta_version: str) -> None:
    ...
    print("Patched for beta:", path, "BETA_CHANNEL_VERSION=", beta_version)
...
def main() -> int:
    ...
    if not path.is_file():
        ...
        return 1
    patch(path, (args.beta_version or "2.0.0").strip() or "2.0.0")
    return 0
