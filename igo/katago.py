...
def _katago_score(move_history, komi=6.5, size=19, rules="japanese"):
...
def _katago_winrate(move_history, komi=6.5, size=19, rules="japanese"):
...
def calculate_territory_chinese(board, komi=6.5, move_history=None, rules="japanese"):
